...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="<?=base_url()?>proyectos/extensiones/<?=$proyecto->proyecto_id?>">Ordenes de cambio</a>
	</li>
...
<div class="row">
	...
	<div class="col-12 col-md-2"><a class="btn btn-primary float-md-right mb-3 mr-md-3 mx-auto d-block d-md-inline-block" href="<?=base_url()?>proyectos/extensiones/<?=$proyecto->proyecto_id?>" role="button"><i class="fa fa-fw fa-arrow-left"></i> Volver a ordenes de cambio</a></div>
</div>
