...
<div class="page-content" ng-controller="proyectoVerTiposOrdenCambio">
	<div class="row">
		...
		<?php if(isset($permisos['colaborador_puestos']['create'])){ ?>
			<div class="col-12 col-md-3"><a class="btn btn-sm btn-primary float-md-right mb-3 mr-md-3 mx-auto d-block d-md-inline-block" href="<?=base_url()?>proyectos/extensiones/agregar-tipo-orden-cambio" role="button"><i class="fa fa-fw fa-plus-circle"></i> Agregar tipo de orden de cambio</a></div>
		<?php } ?>
	</div>
	<div class="card">
				...
				<form id="form-filtro">
					<div class="row">
						...
						<div class="form-group col-12 col-md-4">
							...
							<input type="text" name="proyecto_valor_oferta_extension_tipo" class="form-control" id="proyecto_valor_oferta_extension_tipo"  ng-model="proyecto_valor_oferta_extension_tipo">
							</small>
						</div>
					</div>
					<div class="row">	
	...
	<div class="table-espaciado">
		<div class="table-responsive">
	        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
	            ...
	            <tbody>
					<tr ng-repeat="proyecto_valor_oferta_extension_tipo in proyecto_valor_oferta_extension_tipos | limitTo : cantidad_mostrar : currentPage*cantidad_mostrar">
						<td class="d-md-none">
							<?php if(isset($permisos['proyecto_tipos_orden_cambio']['edit'])){ ?>									
								<a href="<?=base_url()?>proyectos/extensiones/editar-tipo-orden-cambio/{{proyecto_valor_oferta_extension_tipo.proyecto_valor_oferta_extension_tipo_id}}" class="btn btn-edit btn-sm btn-success mb-1"><i class="fa fa-fw fa-edit"></i></a>
							<?php } ?>
