...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2017 a las 06:47:44
...
(1, 1, 3, 0, 2, 38, 1, 'Proyecto 1', '2017-12-16 04:53:04', '2018-02-01', '2018-02-28', '2019-12-31', '11111', '222223', 'Frente a la iglesia', 'Prueba de observaciones nueva'),
...
(5, 1, 4, 0, 1, 1, 1, 'Proyecto 5', '2017-12-16 07:32:27', '1970-01-01', '1970-01-01', '1970-01-01', '12345', '123156498', 'En el estadio', 'Prueba 5'),
...
(1, 5, 1, 1, 100.00, '2017-12-16 04:53:04', 1),
(2, 1, 1, 1, 200.00, '2017-12-16 04:53:04', 1),
(3, 2, 1, 1, 100.00, '2017-12-16 04:53:04', 1),
(4, 3, 1, 1, 300.00, '2017-12-16 04:53:04', 1),
(5, 4, 1, 1, 650.00, '2017-12-16 04:53:04', 1),
...
(22, 1, 5, 1, 110.00, '2017-12-16 07:32:28', 1),
(23, 2, 5, 1, 1010.10, '2017-12-16 07:32:28', 1),
(24, 3, 5, 1, 1010.10, '2017-12-16 07:32:28', 1),
(25, 4, 5, 1, 1010.10, '2017-12-16 07:32:28', 1),
...
--
ALTER TABLE `proyecto_gasto`
  MODIFY `proyecto_gasto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `proyecto_gasto_detalle`
--
ALTER TABLE `proyecto_gasto_detalle`
  MODIFY `proyecto_gasto_detalle_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `proyecto_gasto_estado`
--
ALTER TABLE `proyecto_gasto_estado`
  MODIFY `proyecto_gasto_estado_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `proyecto_gasto_monto`
  MODIFY `proyecto_gasto_monto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `proyecto_gasto_tipo`
--
ALTER TABLE `proyecto_gasto_tipo`
  MODIFY `proyecto_gasto_tipo_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `proyecto_tipo_cambio`
--
ALTER TABLE `proyecto_tipo_cambio`
  MODIFY `proyecto_tipo_cambio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `proyecto_valor_oferta`
--
ALTER TABLE `proyecto_valor_oferta`
  MODIFY `proyecto_valor_oferta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `usuario_bitacora_cambios`
  MODIFY `usuario_bitacora_cambio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `usuario_bitacora_ingreso`
--
ALTER TABLE `usuario_bitacora_ingreso`
  MODIFY `usuario_bitacora_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `usuario_rol_permiso`
  MODIFY `usuario_rol_permiso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
