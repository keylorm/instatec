...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2018 a las 05:45:02
...
(1, 1, '2017-12-07 07:33:46', 'Edica Ltda', '3101005810', 1),
(2, 1, '2017-12-07 07:33:59', 'Cliente 2', '321654987', 0),
(3, 1, '2017-12-07 07:34:33', 'Cliente 3', '987654321', 0),
(4, 1, '2017-12-07 07:34:54', 'BILCO COSTA RICA ', '3-101-595426', 1),
(5, 1, '2017-12-09 03:18:47', 'ALUMIMUNDO SA', '3-101-086859', 1),
(6, 1, '2017-12-09 08:24:07', 'Cliente 6', '23432', 0),
(7, 1, '2017-12-09 08:24:12', 'ARISTA DE CR', '3-101-129926', 0),
(8, 1, '2017-12-09 08:24:17', 'BT CONSULTING AND SERVICES SA', '3-101-277443', 0),
(9, 1, '2017-12-09 08:24:25', 'Cliente 9', '', 0),
(10, 1, '2017-12-09 08:24:31', 'ESCALA', '', 1),
(11, 1, '2017-12-09 08:24:36', 'Edificar S.A', '', 1),
...
(15, 1, '2018-01-12 03:30:09', 'Proycon', '3-101 2', 1);
...
(34, 2, 1, '2018-07-30 23:52:55', 'John', 'Doe', 'jd@instatec.com', '105980789', '54654655', '46', '5646897', 1);
...
(45, 7, 28, 2, '2018-04-25 22:42:40', 1),
...
--
ALTER TABLE `colaborador`
  MODIFY `colaborador_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT de la tabla `colaborador_costo_hora`
--
ALTER TABLE `colaborador_costo_hora`
  MODIFY `colaborador_costo_hora_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `proyecto_colaborador`
  MODIFY `proyecto_colaborador_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
...
--
ALTER TABLE `proyecto_gasto`
  MODIFY `proyecto_gasto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT de la tabla `proyecto_gasto_detalle`
--
ALTER TABLE `proyecto_gasto_detalle`
  MODIFY `proyecto_gasto_detalle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `proyecto_gasto_mano_obra`
  MODIFY `proyecto_gasto_mano_obra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT de la tabla `proyecto_gasto_monto`
--
ALTER TABLE `proyecto_gasto_monto`
  MODIFY `proyecto_gasto_monto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
--
...
--
ALTER TABLE `proyecto_valor_oferta`
  MODIFY `proyecto_valor_oferta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
--
-- AUTO_INCREMENT de la tabla `proyecto_valor_oferta_extension_detalle`
--
ALTER TABLE `proyecto_valor_oferta_extension_detalle`
  MODIFY `proyecto_valor_oferta_extension_detalle_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `usuario_bitacora_cambios`
  MODIFY `usuario_bitacora_cambio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
--
-- AUTO_INCREMENT de la tabla `usuario_bitacora_ingreso`
--
ALTER TABLE `usuario_bitacora_ingreso`
  MODIFY `usuario_bitacora_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
--
-- AUTO_INCREMENT de la tabla `usuario_colaborador`
--
ALTER TABLE `usuario_colaborador`
  MODIFY `usuario_colaborador_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `usuario_detalle`
--
ALTER TABLE `usuario_detalle`
  MODIFY `usuario_detalle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
