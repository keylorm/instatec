...
<hr>
<div class="row">
	<div class="col-12 col-md-10"><h3 class=" text-center text-md-left"><i class="fa fa-fw fa-plus-circle"></i> Agregar nuevo usuario</h3></div>
...
<div class="page-content" ng-controller="agregarUsuarioController">
	<?php 
    ...
    ?>
	<form id="agregarUsuario" class="form-validation" method="post" name="agregarUsuario">
		<div class="card mb-3">
	        ...
	        <div class="card-body">
				<div class="row">
					...
					<div class="form-group col-12 col-md-4">
						...
						<input type="text" name="correo_electronico" class="form-control input-required" id="correo_electronico" aria-describedby="correoHelp">
					...
					<div class="form-group col-12 col-md-4">
						...
						<div class="form-check">
							<label class="form-check-label">
								<input class="form-check-input" type="radio" name="estado_id" id="estado1" value="1" checked>
								Activo
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label">
								<input class="form-check-input" type="radio" name="estado_id" id="estado2" value="0">
								Inactivo
							</label>
						</div>
					</div>
