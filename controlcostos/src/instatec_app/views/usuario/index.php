<script src="<?=base_url()?>src/instatec_pub/js/usuario.js"></script>
<!-- Breadcrumbs-->
<ol class="breadcrumb">
				...
				<form id="form-filtro">
					<div class="row">
						<div class="form-group col-12 col-md-4">
							...
							<input type="text" name="usuario" class="form-control" id="usuario"  ng-model="searchInputs.usuario">
						</div>
						<div class="form-group col-12 col-md-4">
							<label for="nombre">Nombre</label>
							<input type="text" name="nombre" class="form-control" id="nombre"  ng-model="searchInputs.nombre">
							</small>
						</div>
						<div class="form-group col-12 col-md-4">
							<label for="apellidos">Apellidos de usuario</label>
							<input type="text" name="apellidos" class="form-control" id="apellidos"  ng-model="searchInputs.apellidos">
							</small>
						</div>
						<div class="form-group col-12 col-md-4">
							<label for="correo_electronico">Correo de usuario</label>
							<input type="text" name="correo_electronico" class="form-control" id="correo_electronico"  ng-model="searchInputs.correo_electronico">
							</small>
						</div>
						<div class="form-group col-12 col-md-4">
							<label>Rol:</label>
							<select class="form-control" name="rol_id" id="rol_id" aria-describedby="roleHelp" ng-model="searchInputs.rol_id" required="required">
						...
						<div class="form-group col-12 col-md-4">
							...
							<div class="form-check">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="estado_id" id="estado1" ng-value="1" ng-model="searchInputs.estado_id" >
									Activo
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="estado_id" id="estado2" ng-model="searchInputs.estado_id" ng-value="0">
									Inactivo
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="estado_id" id="estado3" ng-value="" ng-model="searchInputs.estado_id" >
									Ambos
								</label>
							</div>
						</div>
	...
	<div class="table-espaciado">
		<div class="table-responsive">
	        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
	            ...
	            <tbody>
					<tr ng-repeat="usuario in usuarios | filter: searchInputs | limitTo : cantidad_mostrar : currentPage*cantidad_mostrar">
						<td class="d-md-none">
