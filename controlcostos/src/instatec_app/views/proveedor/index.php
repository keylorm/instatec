<script src="<?=base_url()?>src/instatec_pub/js/proveedor.js"></script>
<!-- Breadcrumbs-->
<ol class="breadcrumb">
				...
				<form id="form-filtro">
					<div class="row">
						<div class="form-group col-12 col-md-3">
							...
							<input type="text" name="nombre_proveedor" class="form-control" id="nombre" aria-describedby="nombreHelp" ng-model="searchInputs.nombre_proveedor">
							</small>
						</div>
						<div class="form-group col-12 col-md-3">
							<label for="cedula">Cédula de proveedor</label>
							<input type="text" name="cedula_proveedor" class="form-control" id="cedula" aria-describedby="cedulaHelp" ng-model="searchInputs.cedula_proveedor">
						</div>
						<div class="form-group col-12 col-md-3">
							<label>Estado del proveedor:</label>
							<div class="form-check">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="estado_proveedor" id="estado1" ng-value="1" ng-model="searchInputs.estado_proveedor" >
									Activo
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="estado_proveedor" id="estado2" ng-model="searchInputs.estado_proveedor" ng-value="0">
									Inactivo
								</label>
							</div>
						</div>
						<!-- Filtrado previo a utilizar el filtro propio de angular js -->
						<!--
	...
	<div class="table-espaciado">
		<div class="table-responsive">
	        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
	            ...
	            <tbody>
					<tr ng-repeat="proveedor in proveedores | filter: searchInputs | limitTo : cantidad_mostrar : currentPage*cantidad_mostrar">
						<td class="d-md-none">
