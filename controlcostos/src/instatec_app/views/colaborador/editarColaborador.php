	        ...
	        <div class="card-body">
				<div class="row">
					...
					<div class="form-group col-12 col-md-4">
						...
						<input type="text" name="alias" class="form-control" id="alias" aria-describedby="aliasHelp" value="<?=(isset($colaborador['alias']))?$colaborador['alias']:''?>">
	        ...
	        <div class="card-body">
				<div class="row">
					<div class="form-group col-12 col-md-4">
						...
						<input disabled type="text" name="usuario_disabled" class="form-control input-required" id="usuario_disabled" aria-describedby="usuarioHelp" value="<?=(isset($colaborador['usuario']))?$colaborador['usuario']:''?>">
						<input type="hidden" name="usuario" value="<?=(isset($colaborador['usuario']))?$colaborador['usuario']:''?>" />
