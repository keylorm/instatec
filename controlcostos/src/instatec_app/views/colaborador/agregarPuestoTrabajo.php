<script src="<?=base_url()?>src/instatec_pub/js/colaborador.js"></script>
<!-- Breadcrumbs-->
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Agregar puesto</li>
</ol>
<h1  class="text-center"><i class="fa fa-fw fa-users"></i> Puestos de trabajo</h1>
<hr>
<div class="row">
	<div class="col-12 col-md-10"><h3 class=" text-center text-md-left"><i class="fa fa-fw fa-plus-circle"></i> Agregar nuevo puesto</h3></div>
...
<div class="page-content" ng-controller="agregarColaboradorPuestoController">
	<?php 
    ...
    ?>
	<form id="agregarColaboradorPuesto" class="form-validation" method="post" name="agregarColaboradorPuesto">
		<div class="card mb-3">
	        ...
	        <div class="card-body">
				<div class="row">
					<div class="form-group col-12 col-md-4">
						...
						<input type="text" name="puesto" class="form-control input-required" id="puesto" aria-describedby="puestoHelp" value="<?=(isset($post_data['puesto']))?$post_data['puesto']:''?>" >
