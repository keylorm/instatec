				...
				<form id="form-filtro">
					<div class="row">
						...
						<div class="form-group col-12 col-md-4">
							...
							<input type="text" name="puesto" class="form-control" id="puesto"  ng-model="searchInputs.puesto">
							</small>
						</div>
					</div>
	...
	<div class="table-espaciado">
		<div class="table-responsive">
	        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
	            ...
	            <tbody>
					<tr ng-repeat="colaborador_puesto in colaborador_puestos | filter: searchInputs | limitTo : cantidad_mostrar : currentPage*cantidad_mostrar">
						<td class="d-md-none">
