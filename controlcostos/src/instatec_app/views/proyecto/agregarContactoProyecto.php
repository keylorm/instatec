...
<div class="row">
	<div class="col-12 col-md-10"><h3 class=" text-center text-md-left"><i class="fa fa-fw fa-plus-circle"></i> Agregar contacto</h3></div>
	        	...
	        	<div class="row">
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="nombre_contacto" class="form-control input-required" id="nombre" aria-describedby="nombreHelp" >
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="correo_contacto" class="form-control" id="correo_contacto" aria-describedby="correoHelp" >
				...
				<div class="row">	
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="telefono_contacto_1" class="form-control" id="telefono_contacto_1" aria-describedby="telefono1Help" value="<?=(isset($post_data['telefono']))?$post_data['telefono']:''?>">
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="telefono_contacto_2" class="form-control" id="telefono_contacto_2" aria-describedby="telefono2Help" value="<?=(isset($post_data['telefono']))?$post_data['telefono']:''?>">
