		...
		<?php if($rol_id==1){ ?>
			<div class="card mb-3">
					...
					<div class="col-12 col-md-6">
						...
						<a class=" float-md-right btn btn-success  mx-auto d-block d-md-inline-block mb-3" href="<?=base_url()?>proyectos/ordenes-cambio/<?=$proyecto['proyecto_id']?>" role="button"><i class="fa fa-fw fa-eye"></i> Ver ordenes de cambio</a>
					</div>
				</div>
					</div>
			</div>
