...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="<?=base_url()?>proyectos/materiales/<?=$proyecto['proyecto_id']?>/solicitudes-compra-materiales/<?=$solicitud_compra_id?>/ordenes-compra">Ordenes de compra</a>
	</li>
	<li class="breadcrumb-item active">Generar orden de compra</li>
</ol>
...
<div class="page-content">	
	<div class="row">
		<div class="col-12 col-md-12">
			<a class="btn btn-sm btn-secondary float-md-right mb-3 mr-md-3 mx-auto d-block d-md-inline-block" href="<?=base_url()?>proyectos/materiales/<?=$proyecto['proyecto_id']?>/solicitudes-compra-materiales/<?=$solicitud_compra_id?>/ordenes-compra" role="button"><i class="fa fa-fw fa-arrow-left"></i> Volver</a>
		</div>
	</div>	
	<form id="generarProforma" action="" method="post" id="download-form-bottom">
        <?php foreach ($materiales_orden_compra as $kproveedor => $vproveedor) { ?>
        	<div class="card mb-3">
		        ...
		        <div class="card-body collapse" id="container_proveedor_<?=$kproveedor?>">
					...
					<div class="row mt-5 mb-5">
						<div class="col-12">
							<button type="submit" name="generar_orden" value
							="<?=$kproveedor?>" class="btn btn-sm btn-success float-md-right mb-3 mr-md-3 mx-auto d-block d-md-inline-block" role="button"><i class="fa fa-fw fa-download"></i> Generar orden de compra</button>
						</div>
					</div>
					<div class="mb-5 mt-5">
						<div class="card mb-3">
