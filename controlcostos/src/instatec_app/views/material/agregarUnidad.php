...
<h1  class="text-center"><i class="fa fa-fw fa-cog"></i> Unidades</h1>
<hr>
<div class="row">
	<div class="col-12 col-md-10"><h3 class=" text-center text-md-left"><i class="fa fa-fw fa-plus-circle"></i> Agregar unidad</h3></div>
...
<div class="page-content" ng-controller="agregarUnidadController">
	<?php 
    ...
    ?>
	<form id="agregarUnidad" class="form-validation" method="post" name="agregarUnidad">
		<div class="card mb-3">
	        ...
	        <div class="card-body">
				<div class="row">
					<div class="form-group col-12 col-md-4">
						...
						<input type="text" name="material_unidad" class="form-control input-required" id="material_unidad" aria-describedby="tipoHelp" value="<?=(isset($post_data['material_unidad']))?$post_data['material_unidad']:''?>" >
						<small id="tipoHelp" class="form-text text-muted">Ingrese el nombre de la unidad.<br/>
						</small>
					</div>
