				...
				<form id="form-filtro">
					<div class="row">
						...
						<div class="form-group col-12 col-md-4">
							...
							<input type="text" name="material" class="form-control" id="material"  ng-model="searchInputs.material">
							</small>
						</div>
						<div class="form-group col-12 col-md-4">
							<label for="material_codigo">Código de material</label>
							<input type="text" name="material_codigo" class="form-control" id="material_codigo"  ng-model="searchInputs.material_codigo">
							</small>
						</div>
					</div>
	...
	<div class="table-espaciado">
		<div class="table-responsive">
	        <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
	            ...
	            <tbody>
					<tr ng-repeat="material in materiales | filter:searchInputs | limitTo : cantidad_mostrar : currentPage*cantidad_mostrar">
						<td class="d-md-none">
